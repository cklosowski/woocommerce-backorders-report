...
CURRENTDIR=`pwd`
MAINFILE="woocommerce-backorders-report.php" # this should be the name of your main php file in the wordpress plugin
...
NEWVERSION2=`grep "^(* Version|Version)" $GITPATH/$MAINFILE | awk -F' ' '{print $2}' | sed 's/[[:space:]]//g'`
